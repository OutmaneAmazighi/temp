        ...
        async _InitDOM(opts, port2) {
            ...
            if (this._scriptsType === "module") {
                ...
                for (let [originalUrl, loadUrl] of allProjectScripts) {
                    ...
                    } else if (originalUrl === "scriptsInEvents.js" || originalUrl.endsWith("/scriptsInEvents.js")) await AddScript(loadUrl,
                        this._scriptsType)
                }
            ...
            if (this._exportType === "preview" && typeof self.C3.ScriptsInEvents !==
                "object") {
            ...
            await self["C3_InitRuntime"](this._localRuntime,
                runtimeOpts)
        }
